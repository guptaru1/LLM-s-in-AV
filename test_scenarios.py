...
def generate_mm_scenarios(scenario_dimension, is_in_car, is_interventionism, is_law):
    ...
    print(case_1_description)
    print (" ---------------")
    print(case_2_description)

    return system_content, user_content, scenario_info


# Generate scenarios using generate_mm_scenarios
mm_system_content, mm_user_content, mm_scenario_info = generate_mm_scenarios("species", 1, 1, 0)

# Generate scenarios using generate_scenarios
system_content, user_content, scenario_info = generate_scenarios("species", 1, 1, 0)

# Compare outputs
print("System content:", mm_system_content == system_content)
print("User content:", mm_user_content == user_content)
print("Scenario info:", mm_scenario_info == scenario_info)
